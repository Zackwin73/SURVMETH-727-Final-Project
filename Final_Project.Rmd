---
title: "Why Voter Turnout Increases While Trust in Politicians Diminishes: Florida Exploratory Study"
...
Html Link **(Use for final review because it has the interactive plots and paper was made with Html in mind)**: https://rpubs.com/ZWin1234/1379033
...
```{r flvoting scrape, eval=FALSE, include=FALSE}
...
```{r echo=FALSE}
mods <- list(
  "Avg Turnout" = model_avg_turnout,
  "Avg Vote Percent" = model_avg_pct
)
...
```{r eval=FALSE, include=FALSE}
saveRDS(sent_2016, "sent_2016_scores.rds")
saveRDS(sent_2020, "sent_2020_scores.rds")
```
