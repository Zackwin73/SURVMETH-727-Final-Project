...
HTML link **(HTML format is how original paper was formatted and includes the interactive plots.)** :https://rpubs.com/ZWin1234/1379120
...
(To add context, I include an interactive plot where each point represents a county to show exactly where all 67 counties in Florida fall on the plot. You can double click a county name in the legend to isolate a single county and see the vote percentage it had in each of the three presidential general election years.) (**See HTML version to see interactive plot called "Interactive County Turnout"**)
...
ggplot(co_change, aes(x = change_16_24, y = CasesAll, color = County)) +
  ...
  labs(
    title = "COVID Cases vs Voter Turnout Change",
...
**(included static graph for stand in for the interactive plot that goes here: use the HTML link in beginning of paper to see the interactive plot. Plot titled "COVID Cases vs Voter Turnout Change")** 
